...
- The `{project-root}/_bmad/core/tasks/validate-workflow.yaml` framework will automatically:
...
3. **Load validation framework**: `{project-root}/_bmad/core/tasks/validate-workflow.yaml`
