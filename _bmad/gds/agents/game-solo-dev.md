...
<activation critical="MANDATORY">
  ...
  <menu>
    ...
    <item cmd="AE or fuzzy match on advanced-elicitation" exec="{project-root}/_bmad/core/workflows/advanced-elicitation/workflow.yaml">[AE] Advanced elicitation techniques to challenge the LLM to get better results</item>
