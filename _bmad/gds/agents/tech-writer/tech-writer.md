...
<activation critical="MANDATORY">
  ...
  <menu>
    ...
    <item cmd="DP or fuzzy match on document-project" exec="{project-root}/_bmad/gds/workflows/document-project/workflow.md">[DP] Document Project: Generate comprehensive project documentation (brownfield analysis, architecture scanning)</item>
