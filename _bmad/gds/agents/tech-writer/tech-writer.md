...
<activation critical="MANDATORY">
  ...
  <menu>
    ...
    <item cmd="DP or fuzzy match on document-project">[DP] Document Project: Generate comprehensive project documentation (brownfield analysis, architecture scanning)</item>
